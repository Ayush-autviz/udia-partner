...
import { updateProfilePicture  } from '../actions/PartnerRegisterActions';
...
const Register = (props) => {
  ...
  const registration = async() => {
    ...
    await axios({
      ...
      data:{ delivery_boy_name: customer_name , phone_number: phone_number_value , fcm_token: global.fcm_token, phone_with_code: phone_with_code_value, password: password }
    })
    .then(async response => {
      setLoading(false);
